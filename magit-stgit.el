...
;; Package-Requires: ((emacs "25.1") (magit "2.12.0") (magit-popup "2.12.0") (transient "20190812") (dash "20180910") (with-editor "20181103"))
...
PROMPT."
  (let* ((region (and use-region (magit-region-values 'stgit-patch)))
    ...
    (or (and use-marks
        ...
        (list (or (and use-point (--when-let
                                     (magit-current-section)
                                   (when
                                       (magit-section-match 'stgit-patch it)
                                     (oref it value))))
